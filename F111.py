...
back_btn_img = PhotoImage(file='previous.gif')
forward_btn_img = PhotoImage(file='next.gif')
play_btn_img = PhotoImage(file='pause.gif')
pause_btn_img = PhotoImage(file='play.gif')
stop_btn_img = PhotoImage(file='square.png')
return_btn_img = PhotoImage(file='back_arrow.png')
...
my_menu.add_cascade(label = "Add Audios", menu=add_song_menu)
add_song_menu.add_command(label="Add One audio To Menu", command=add_song)

# Add Many Songs to Menu
add_song_menu.add_command(label="Add Many audios To Menu", command=add_many_songs)


# Add a Song to the Playlist
add_song_menu.add_command(label="Add One audio To Playlist", command=add_song_playlist)

# Add Many Songs to the Playlist
add_song_menu.add_command(label="Add Many audios To Playlist", command=add_many_songs_playlist)

# Add One Song from Menu to Playlist
add_song_menu.add_command(label="Add Selected audio To Playlist", command=one_from_menu)

# Add One Song from Menu to Playlist
add_song_menu.add_command(label="Add All audios To Playlist", command=all_from_menu)


# Create Delete Song Menu
remove_song_menu = Menu(my_menu, tearoff=0)
my_menu.add_cascade(label="Remove audios", menu = remove_song_menu)
remove_song_menu.add_command(label="Delete A audio From Menu", command = delete_song)
remove_song_menu.add_command(label="Delete All audios From Menu", command = delete_all_songs)
remove_song_menu.add_command(label="Delete a audio From Playlist", command = delete_song_playlist)
remove_song_menu.add_command(label="Delete All audios From Playlist", command = delete_all_songs_playlist)
